...
func NewBServiceProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) BService {
	...
	serviceURL += baseServicePath(pathPrefix, "serviceb", "BService")
	urls := [1]string{
		serviceURL + "DoIt",
	}
...
const BServicePathPrefix = "/twirp/serviceb.BService/"
...
func (s *bServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "serviceb.BService" {
...
func (s *bServiceServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "serviceb", "BService")
}
